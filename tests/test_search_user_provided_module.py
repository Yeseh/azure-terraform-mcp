...
import pytest
import sys
from xebiams.terraform_mcp_server.impl.tools.search_user_provided_module import (
    get_module_details,
    parse_module_url,
...
@patch('xebiams.terraform_mcp_server.impl.tools.utils.get_github_release_details')
@patch('xebiams.terraform_mcp_server.impl.tools.utils.get_variables_tf')
...
@patch('xebiams.terraform_mcp_server.impl.tools.search_user_provided_module.get_module_details')
...
async def test_get_module_details_with_github_source(mock_requests_get):
    ...
    with patch(
        'xebiams.terraform_mcp_server.impl.tools.utils.get_github_release_details'
    ) as mock_get_github_release_details:
        with patch(
            'xebiams.terraform_mcp_server.impl.tools.utils.get_variables_tf'
