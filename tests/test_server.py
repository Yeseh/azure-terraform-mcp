...
from xebiams.terraform_mcp_server.server import (
    main,
    mcp,
...
class TestTools:
    ...
    @pytest.mark.asyncio
    @patch('xebiams.terraform_mcp_server.server.execute_terraform_command_impl')
    async def test_execute_terraform_command(self, mock_execute_terraform_command_impl):
        ...
        from xebiams.terraform_mcp_server.server import execute_terraform_command
    ...
    @pytest.mark.asyncio
    @patch('xebiams.terraform_mcp_server.server.search_aws_provider_docs_impl')
    async def test_search_aws_provider_docs(self, mock_search_aws_provider_docs_impl):
        ...
        from xebiams.terraform_mcp_server.server import search_aws_provider_docs
    ...
    @pytest.mark.asyncio
    @patch('xebiams.terraform_mcp_server.server.search_awscc_provider_docs_impl')
    async def test_search_awscc_provider_docs(self, mock_search_awscc_provider_docs_impl):
        ...
        from xebiams.terraform_mcp_server.server import search_awscc_provider_docs
    ...
    @pytest.mark.asyncio
    @patch('xebiams.terraform_mcp_server.server.search_specific_aws_ia_modules_impl')
    async def test_search_specific_aws_ia_modules(self, mock_search_specific_aws_ia_modules_impl):
        ...
        from xebiams.terraform_mcp_server.server import search_specific_aws_ia_modules
    ...
    @pytest.mark.asyncio
    @patch('xebiams.terraform_mcp_server.server.run_checkov_scan_impl')
    async def test_run_checkov_scan(self, mock_run_checkov_scan_impl):
        """Test the run_checkov_scan function."""
        from xebiams.terraform_mcp_server.server import run_checkov_scan
    ...
    @pytest.mark.asyncio
    @patch('xebiams.terraform_mcp_server.server.search_user_provided_module_impl')
    async def test_search_user_provided_module(self, mock_search_user_provided_module_impl):
        ...
        from xebiams.terraform_mcp_server.server import search_user_provided_module
    ...
    @pytest.mark.asyncio
    @patch('xebiams.terraform_mcp_server.server.execute_terragrunt_command_impl')
    async def test_execute_terragrunt_command(self, mock_execute_terragrunt_command_impl):
        ...
        from xebiams.terraform_mcp_server.server import execute_terragrunt_command
...
class TestResources:
    ...
    @pytest.mark.asyncio
    @patch('xebiams.terraform_mcp_server.server.TERRAFORM_WORKFLOW_GUIDE', 'Test workflow guide')
    async def test_terraform_development_workflow_content(self):
        """Test the terraform_development_workflow resource content."""
        from xebiams.terraform_mcp_server.server import terraform_development_workflow
    ...
    @pytest.mark.asyncio
    @patch(
        'xebiams.terraform_mcp_server.server.AWS_TERRAFORM_BEST_PRACTICES', 'Test best practices'
    )
    async def test_terraform_aws_best_practices_content(self):
        """Test the terraform_aws_best_practices resource content."""
        from xebiams.terraform_mcp_server.server import terraform_aws_best_practices
...
class TestMain:
    ...
    @patch('xebiams.terraform_mcp_server.server.mcp')
