...
from xebiams.terraform_mcp_server.impl.tools.utils import (
    clean_description,
...
from xebiams.terraform_mcp_server.models import TerraformVariable
...
"""
    ...
    def test_extract_outputs_from_readme_with_list(self):
        ...
        with patch(
            'xebiams.terraform_mcp_server.impl.tools.utils.extract_outputs_from_readme'
        ) as mock_extract:
...
class TestParseVariablesTf:
    ...
    def test_parse_variables_tf_with_variables(self):
        ...
        with patch(
            'xebiams.terraform_mcp_server.impl.tools.utils.parse_variables_tf'
        ) as mock_parse:
