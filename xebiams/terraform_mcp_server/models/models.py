...
class TerraformAzureProviderDocsResult(TerraformProviderDocsResult):
    """Model representing documentation results for Azure Terraform Providers (azurerm, azuread, azapi).

    Attributes:
        provider: The Azure provider name (azurerm, azuread, or azapi)
        arguments: List of arguments with descriptions specific to Azure provider resources.
        attributes: List of attributes with descriptions specific to Azure provider resources.
        import_info: Information about how to import existing resources.
        timeouts: Information about resource timeouts configuration.
    """

    provider: Literal['azurerm', 'azuread', 'azapi'] = Field(
        'azurerm', description='The Azure provider name'
    )
    arguments: Optional[List[Dict[str, str]]] = Field(
        None, description='List of arguments with descriptions'
    )
    ...
    import_info: Optional[str] = Field(
        None, description='Information about importing existing resources'
    )
    timeouts: Optional[Dict[str, str]] = Field(
        None, description='Resource timeout configuration information'
    )
